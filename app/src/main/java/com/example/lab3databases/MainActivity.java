...
//                Toast.makeText(MainActivity.this, "Add product", Toast.LENGTH_SHORT).show();
        ...
        findBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //finds what data is entered in field and sets cursor to data
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, cursor.getCount() + " items deleted", Toast.LENGTH_SHORT).show();
                viewProducts();
            }
        });
    ...
    private void view(Cursor cursor) {
        productList.clear();
        if (cursor.getCount() == 0) {
            Toast.makeText(MainActivity.this, "Nothing to show", Toast.LENGTH_SHORT).show();
        } else {
